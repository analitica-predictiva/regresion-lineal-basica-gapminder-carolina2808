...
def pregunta_02():
    ...
    mean_life_rounded = round(mean_life, 4)
    print(mean_life_rounded)
    ...
    correlation2 = df["GDP"].corr(df["life"])
    correlation_rounded2 = round(correlation2, 4) 
    print(correlation_rounded2)
...
def pregunta_03():
    ...
    r2 = reg.score(X_fertility.values.reshape(-1, 1), y_life)
    print(round(r2, 4))
...
def pregunta_04():
    ...
    (X_train, X_test, y_train, y_test,) = train_test_split(X_fertility.values.reshape(-1, 1), y_life, test_size=0.2, random_state=53)
